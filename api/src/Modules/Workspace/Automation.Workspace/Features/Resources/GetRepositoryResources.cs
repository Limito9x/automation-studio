...
using Automation.Workspace.Features.Repositories;
    ...
    : Endpoint<GetRepositoryResourcesQuery, PagedResult<WorkspaceResourceDto>>
{
    ...
    {
        Get(WorkspaceRoutes.RepositoryResources);
...
[NonTransactional]
public class GetRepositoryResourcesHandler(WorkspaceDbContext db, IContentApi contentApi)
{
