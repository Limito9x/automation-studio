...
namespace Automation.Runner.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260926054054_AddRunnerHardwareProfile")]
    partial class AddRunnerHardwareProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Automation.Runner.Domain.Entities.Runner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("LastHardwareScannedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("PrimaryGpuName")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");

                    b.Property<long>("PrimaryGpuVramBytes")
                    ...
                    b.ToTable("Runners", "runner");
                });

            modelBuilder.Entity("Automation.Runner.Domain.Entities.RunnerExecutorConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RunnerId", "ExecutorKey")
                        .IsUnique();

                    b.ToTable("RunnerExecutorConfigs", "runner");
                });

            modelBuilder.Entity("Automation.Runner.Domain.Entities.RunnerStudio", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RunnerId", "StudioId")
                        .IsUnique();

                    b.ToTable("RunnerStudios", "runner");
                });
            ...
            modelBuilder.Entity("Automation.Runner.Domain.Entities.RunnerExecutorConfig", b =>
                {
                    b.HasOne("Automation.Runner.Domain.Entities.Runner", "Runner")
