...
namespace Automation.Repository.Features.ResourceVersions;
...
public class UpdateResourceMetadataHandler(RepositoryDbContext db, ITagApi tagApi)
{
    ...
    )
    {
        ...
        version.UpdateMetadata(newMetadataDoc);
