...
export function ResetPasswordForm({ email, token, className, ...props }: ResetPasswordFormProps) {
        ...
        <CardContent className="p-6 md:p-8">
          <div className="flex flex-col gap-6">
            ...
            <div className="grid gap-6">
              <Form id="reset-password-form" form={form} onSubmit={onSubmit} className="flex flex-col gap-4">
                <FormInput
